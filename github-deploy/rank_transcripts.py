...
def load_controls() -> tuple[list[dict], dict, dict]:
    """Anchor transcripts with established scores (controls/; built offline from the scripted level runs and two RealHumanEval sessions): returns (records, tasks, expected)."""
